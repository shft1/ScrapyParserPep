...
## Парсер, реализованный на базе асинхронного фреймворка Scrapy,  который собирет информацию о всех существующих документах PEP и сохраняет ее в соответствующие файлы:
